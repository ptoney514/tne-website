    ...
    <div className="flex flex-col h-full">
      ...
      <div className="bg-white border-b border-admin-card-border px-6 py-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-[22px] font-extrabold text-admin-text tracking-[-0.02em]">Registration Settings</h1>
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-admin-red hover:opacity-85 disabled:bg-stone-300 text-white font-medium transition-colors"
          >
            {saving ? (
      ...
      {/* Content */}
      <div className="flex-1 overflow-auto bg-admin-content-bg p-6">
        {/* Status Messages */}
        {error && (
        ...
        {success && (
          <div className="mb-6 px-4 py-3 rounded-[12px] bg-green-50 border border-green-200 text-green-700 text-sm flex items-center gap-2">
        ...
        <div className="max-w-2xl space-y-6">
          {/* Season Selector */}
          <div className="bg-white rounded-[12px] border-[1.5px] border-admin-card-border p-6">
            <h2 className="text-base font-bold text-admin-text mb-4">Season</h2>
            <div>
          ...
          {selectedSeasonId && (
            <div className="bg-white rounded-[12px] border-[1.5px] border-admin-card-border p-6">
              <h2 className="text-base font-bold text-admin-text mb-4">
                Registration Status
              </h2>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <p className="font-medium text-admin-text">Registration Open</p>
          ...
          {selectedSeasonId && (
            <div className="bg-white rounded-[12px] border-[1.5px] border-admin-card-border p-6">
              <div className="flex items-center gap-2 mb-4">
                <Eye className="w-5 h-5 text-admin-text-secondary" />
                <h2 className="text-base font-bold text-admin-text">Preview</h2>
              </div>

              <div className="bg-stone-900 rounded-lg p-6">
                <p className="text-xs text-admin-text-muted uppercase tracking-wider mb-3">
                  Homepage Display
                </p>
                ...
                {registrationOpen ? (
                  <div className="space-y-3">
                    {/* Status Pill Preview */}
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-admin-red/30 bg-admin-red/10">
                      <div className="w-1.5 h-1.5 rounded-full bg-admin-red animate-pulse" />
                      <span className="text-[10px] font-admin-mono font-medium text-red-300 uppercase tracking-widest">
                    ...
                    {/* Button Preview */}
                    <div>
                      <span className="inline-flex items-center gap-2 px-4 py-2 bg-admin-red text-white text-sm font-medium rounded-lg">
                  ...
                  <div>
                    <span className="inline-flex items-center gap-2 px-4 py-2 bg-stone-600 text-admin-text-muted text-sm font-medium rounded-lg cursor-not-allowed">
