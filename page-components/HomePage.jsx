          ...
          <div className="flex flex-col items-center text-center space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4 pointer-events-auto">
              {loading || isTryoutsOpen ? (
                ...
                <Link href="/contact" className="group relative px-8 py-3 bg-stone-700 text-white text-sm font-semibold uppercase tracking-wider overflow-hidden transition-all hover:bg-stone-600 shadow-lg shadow-stone-700/25">
                  <span className="relative z-10 flex items-center gap-2">
                    Join Waitlist
                    <ArrowRight className="w-4 h-4 transition-transform group-hover:translate-x-1" />
                  </span>
          ...
          <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-0 border border-stone-200 rounded-lg overflow-hidden">
              ...
              <div className="lg:border-r border-stone-200 p-8 flex flex-col h-full bg-stone-50/50 hover:bg-white transition-colors group">
                ...
                <Link href="/skills-academy" className="text-sm font-semibold text-stone-950 flex items-center gap-2 group-hover:gap-4 transition-all">
          ...
          <div className="max-w-4xl mx-auto px-6 relative z-10 text-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              {loading || isTryoutsOpen ? (
                ...
                <Link href="/contact" className="h-12 px-8 bg-stone-700 text-white font-medium hover:bg-stone-600 transition-all shadow-xl shadow-stone-700/20 flex items-center gap-2 hover:scale-105 active:scale-95 duration-200">
                  <span>Join Waitlist</span>
                  <ChevronRight className="w-4 h-4" />
                </Link>
              )}
              <Link href="/contact" className="h-12 px-8 rounded border border-stone-300 text-stone-600 font-medium hover:bg-white hover:text-stone-900 transition-all bg-white/50 backdrop-blur-sm flex items-center">
                Contact Coaches
              </Link>
            </div>
          </div>
