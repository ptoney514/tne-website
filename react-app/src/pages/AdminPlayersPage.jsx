    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
      <div className="bg-white rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto shadow-xl">
        <div className="flex items-center justify-between px-6 py-4 border-b border-stone-200">
          <h2 className="text-xl font-semibold text-stone-900">{player ? 'Edit Player' : 'Add Player'}</h2>
    ...
    <tr className="border-b border-stone-100 hover:bg-stone-50 transition-colors">
      <td className="px-4 py-3">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-medium text-stone-900">{player.first_name} {player.last_name}</p>
            <p className="text-xs text-stone-500">{player.current_grade} • {calculateAge(player.date_of_birth)} yrs</p>
          </div>
        </div>
      </td>
        ...
        {player.teams?.length > 0 ? (
          <div className="flex flex-wrap gap-1">
            {player.teams.map((team) => (
              <span
                key={team.id}
                className="px-2 py-0.5 rounded-full text-xs bg-tne-red/10 text-tne-red"
              >
                {team.name}
              </span>
            ))}
      ...
      <td className="px-4 py-3 text-sm text-stone-600">
        {player.primary_parent ? (
          <div>
            ...
            <p className="text-xs text-stone-500">{player.primary_parent.phone}</p>
          </div>
        ) : (
      ...
      <main className="flex-1 px-4 py-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-8">
            <Link
              to="/admin"
              className="flex items-center gap-1 text-sm text-stone-500 hover:text-stone-900 mb-4 transition-colors"
            >
            ...
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-3xl font-bebas tracking-tight text-stone-900">Player Management</h1>
          ...
          <div className="mb-6">
            <div className="relative max-w-md">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-white border border-stone-300 text-stone-900 placeholder-stone-400 focus:outline-none focus:ring-2 focus:ring-tne-red/20 focus:border-tne-red"
              />
            </div>
          </div>
            ...
            <div className="rounded-2xl bg-white border border-stone-200 overflow-hidden shadow-sm">
              <table className="w-full">
                <thead className="bg-stone-50">
                  <tr>
                    <th className="px-4 py-3 text-left text-xs font-medium text-stone-500 uppercase tracking-wider">Player</th>
                    <th className="px-4 py-3 text-left text-xs font-medium text-stone-500 uppercase tracking-wider">Position</th>
                    <th className="px-4 py-3 text-left text-xs font-medium text-stone-500 uppercase tracking-wider">Jersey</th>
                    <th className="px-4 py-3 text-left text-xs font-medium text-stone-500 uppercase tracking-wider">Team(s)</th>
                    <th className="px-4 py-3 text-left text-xs font-medium text-stone-500 uppercase tracking-wider">Parent</th>
