...
function AdminNavLink({ href, children, badge }) {
        ...
        <div className="flex h-14 items-center justify-between">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="hidden md:flex items-center gap-1.5">
              ...
              <AdminNavLink href="/admin/games">Tournament Schedule</AdminNavLink>
              <AdminNavLink href="/admin/practices">Practices</AdminNavLink>
              {/* AI Chat disabled for MVP - re-enable post-MVP (see issue #59)
              <AdminNavLink href="/admin/chat-analytics">
          ...
          <div className="px-4 py-3 space-y-1">
            <Link
              ...
              className={`block px-3 py-2 rounded-lg text-sm font-medium ${
                isMobileActive('/admin/teams') ? 'bg-tne-red text-white' : 'text-stone-600 hover:bg-stone-100'
              }`}
            >
              Teams
            </Link>
            <Link
              ...
              onClick={() => setMobileMenuOpen(false)}
              className={`block px-3 py-2 rounded-lg text-sm font-medium ${
                isMobileActive('/admin/players') ? 'bg-tne-red text-white' : 'text-stone-600 hover:bg-stone-100'
              }`}
            >
              Players
            </Link>
            ...
            <Link
              ...
              onClick={() => setMobileMenuOpen(false)}
              className={`flex items-center justify-between px-3 py-2 rounded-lg text-sm font-medium ${
                isMobileActive('/admin/registrations') ? 'bg-tne-red text-white' : 'text-stone-600 hover:bg-stone-100'
              }`}
            >
              Registrations
            ...
            <Link
              ...
              onClick={() => setMobileMenuOpen(false)}
              className={`block px-3 py-2 rounded-lg text-sm font-medium ${
                isMobileActive('/admin/games') ? 'bg-tne-red text-white' : 'text-stone-600 hover:bg-stone-100'
              }`}
            >
              Tournament Schedule
            </Link>
            <Link
              ...
              onClick={() => setMobileMenuOpen(false)}
              className={`block px-3 py-2 rounded-lg text-sm font-medium ${
                isMobileActive('/admin/practices') ? 'bg-tne-red text-white' : 'text-stone-600 hover:bg-stone-100'
              }`}
            >
              Practices
            </Link>
            ...
            <Link
              ...
              className={`flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium ${
                isMobileActive('/admin/chat-analytics') ? 'bg-tne-red text-white' : 'text-stone-600 hover:bg-stone-100'
              }`}
            >
              <ChatIcon />
              AI Chat Analytics
